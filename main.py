...
def generate_response(uploaded_file, openai_api_key, query_text):
    try:
        ...
        # If a file is uploaded, process it with vector search
        if uploaded_file is not None:
            ...
            # If no file is uploaded, directly use the LLM to answer the query
...
# Query text (enabled regardless of file upload)
